...
ng serve</code></pre>
            ...
            <p class="text-lg mb-4">The application should run at <i class="bg-highlight px-2 py-1 rounded-border not-italic text-base">http://localhost:5049/</i> to view the application in your local environment.</p>
