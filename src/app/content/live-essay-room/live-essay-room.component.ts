...
export class LiveEssayRoomComponent implements OnInit, OnDestroy {
    ...
    editingNote = signal<TeacherNoteEvent | null>(null);
    ...
    openEditCommentModal(note: TeacherNoteEvent): void {
    ...
    saveEditedComment(): void {
        ...
        this.essayService.updateComment(numericId, newText).subscribe({
            next: (updated) => {
                this.teacherNotes.update(notes =>
