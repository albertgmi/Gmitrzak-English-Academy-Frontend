...
@Component({
    ...
    templateUrl: './irregular-verbs-study.component.html',
    styleUrls: ['./irregular-verbs-study.component.scss']
})
export class IrregularVerbsStudyComponent implements OnInit {
    ...
    currentCard = signal<SessionVerbCard | null>(null);
