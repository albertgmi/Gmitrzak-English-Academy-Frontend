...
export class AppMenu {
  ...
  ngOnInit() {
    ...
    this.model = this.buildMenu(role);
  }

  private buildMenu(role: string | null): MenuItem[] {
    const base: MenuItem[] = [
      {
        label: 'Home',
        items: [
        ...
        items: [
          ...
          },
          {
            ...
            items: [
              ...
              { label: 'Create Matrix', icon: 'pi pi-plus-circle',   routerLink: ['/system/matrices/create'] },
              { label: 'Plan Matrix',   icon: 'pi pi-calendar-plus', routerLink: ['/system/matrices/plan'] },
              { label: 'Modules',       icon: 'pi pi-box',           routerLink: ['/system/modules'] },
              { label: 'Create Module', icon: 'pi pi-plus-circle',   routerLink: ['/system/modules/create'] },
    ...
    return [
      {
        label: 'Learning',
        items: [
          { label: 'Flashcards',    icon: 'pi pi-clone',      routerLink: ['/flashcards'] },
          ...
          { label: 'Word Finder',   icon: 'pi pi-search',     routerLink: ['/wordfinder'] },
        ]
      },
      {
        label: 'Progress',
